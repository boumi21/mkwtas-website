...
am4core.ready(function() {
    ...
    var chart = am4core.create("chartdiv_flaps", am4charts.XYChart);
    
    // Set up data source
    chart.dataSource.url = "php_scripts/charts/stat_tas_time-flaps.php";
    ...
    title.text = "[bold]Total Time Flaps[/] \n (Zoom in for details)";
    title.fontSize = 25;
    ...
    $.getJSON('php_scripts/charts/stat_tas_time-flaps.php', function(jsonData) {                       
      ...
      $("#info_chart2").text("Time cut of " + timeCut + " seconds in " + size + " days from " + firstDate + " to " + lastDate);
    });
