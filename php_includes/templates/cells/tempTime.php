<td>
    ...
    if ($data['flap_no_bkt']) {
        echo "<img class='icon-zoom mb-1 ml-1' src='assets/img/svg/snail.svg' width='22px' alt='' data-toggle='popover' tabindex='0' data-trigger='focus' data-content='" . $flapNoBktDesc . "' title='Flap isn&rsquo;t true BKT'>";
    }
